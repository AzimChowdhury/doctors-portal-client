        ...
        <div className='w-96 mx-auto p-6 rounded-lg items-center mt-3 shadow-2xl'>
            ...
            <form onSubmit={handleSubmit(handleFormSubmit)}>
                <div class="form-control w-full max-w-xs">
                    ...
                    {errors.name?.type === 'required' && <p className='text-red-600'><small>name is required</small></p>}
                </div>
                <div class="form-control w-full max-w-xs">
                    <label class="label">
                ...
                <div class="form-control mt-4 w-full max-w-xs">
                    <input type="submit" value='Register' class="btn btn-accent w-full max-w-xs" />
                </div>
                <p className='py-2'><small>Already have an account ? <Link className='text-primary font-medium' to='/login'>Log In </Link></small></p>
